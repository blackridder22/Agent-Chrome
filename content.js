// content.js - Content script for Agent Chrome extension

let selectedText = '';
let addButton = null;

// Function to create and show the "Add to Agent Chrome" button
function createAddButton(x, y) {
  // Remove existing button if any
  removeAddButton();

  addButton = document.createElement('div');
  addButton.id = 'agent-chrome-add-button';
  addButton.innerHTML = '📋 Add to Agent Chrome';
  ...
  addButton.addEventListener('click', () => {
    if (selectedText) {
      // Send message to background script to open side panel with text
